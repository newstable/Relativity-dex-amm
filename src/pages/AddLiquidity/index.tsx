...
import { AutoColumn, ColumnCenter, PlusButton } from 'components/Column'
...
export default function AddLiquidity({
  ...
  const onAdd = useCallback(async () => {
    ...
    account, addTransaction, allowedSlippage,
    chainId, currencies, currencyA, currencyB,
    deadline, library, noLiquidity, parsedAmounts
  ])
          ...
          <CardBody>
            <AutoColumn gap="20px">
              ...
              <div style={{ display: "flex", position: "relative" }}>
                ...
                />
                <PlusButton >
                  <AddIcon style={{ width: "40px", height: "40px" }} color="black" />
                </PlusButton>
                <CurrencyInputPanel
