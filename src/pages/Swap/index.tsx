          ...
          <CardBody >
            <AutoColumn gap="md" style={{ display: "flex" }}>
              <CurrencyInputPanel
                ...
                tokenStatue="You send"
              />
              <AutoColumn justify="space-between" style={{
                ...
                <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable>
                    <IconButton
                      ...
                      style={{ borderRadius: '50%', border: "1px solid white", width: "70px", height: "70px", backgroundColor: "white" }}
                      size="sm"
                    >
                      <TradeIcon />
                    </IconButton>
                ...
                <AutoColumn gap="4px">
                  {Boolean(trade) && (
                    <RowBetween align="center">
                      <Text color="card" fontSize="14px">Price</Text>
                      <TradePrice
                  ...
                  {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                    <RowBetween align="center">
                      <Text color="card" fontSize="14px">Slippage Tolerance</Text>
                      {/* <Text color="card" fontSize="14px">{allowedSlippage / 100}%</Text> */}
                    </RowBetween>
                  )}
                </AutoColumn>
              </Card>
