...
import { ButtonMenu, ButtonMenuItem, IconButton, useModal } from '@pancakeswap-libs/uikit';
  ...
  return (
    <StyledNav>
      <ButtonMenu activeIndex={activeIndex} size="sm" variant="subtle">
        <ButtonMenuItem id="swap-nav-link" to="/swap" as={Link} style={{ height: "50px" }}>
          <TranslatedText translationId={8}>Swap</TranslatedText>
        </ButtonMenuItem>
        <ButtonMenuItem id="pool-nav-link" to="/pool" as={Link} style={{ height: "50px" }}>
          <TranslatedText translationId={74}>Liquidity</TranslatedText>
        </ButtonMenuItem>
      </ButtonMenu>
      <div style={{ margin: "auto", marginRight: "0px" }}>
        <IconButton variant="text" onClick={() => { console.log("onclick"); onPresentSettings() }} title="Settings">
          <CogIcon />
        </IconButton>
